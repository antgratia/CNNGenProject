...
try:
	def getModel():
		...
		X1 = X
		X1 = MaxPooling2D(pool_size=1, strides=1, padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(16, kernel_size=4, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		...
		X = Conv2D(32, kernel_size=1, strides=1, activation='selu', padding='valid')(X)
		X = AveragePooling2D(pool_size=6, strides=4, padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(64, kernel_size=2, strides=2, activation='tanh', padding='valid')(X)
		...
		X1 = Conv2D(128, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X = Concatenate()([X, X1])
		X = MaxPooling2D(pool_size=3, strides=1, padding='same')(X)

		X2 = X1
		X2 = Conv2D(128, kernel_size=1, strides=1, activation='selu', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = Conv2D(128, kernel_size=1, strides=1, activation='relu', padding='same')(X2)
		...
		X3 = Conv2D(128, kernel_size=1, strides=1, activation='selu', padding='same')(X3)
		X3 = Dropout(0.20)(X3)
		X3 = Conv2D(128, kernel_size=1, strides=1, activation='tanh', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X3 = Conv2D(128, kernel_size=1, strides=1, activation='relu', padding='same')(X3)
		X3 = AveragePooling2D(pool_size=7, strides=1, padding='same')(X3)
		...
		X4 = Conv2D(128, kernel_size=1, strides=1, activation='selu', padding='same')(X4)
		...
		X4 = Conv2D(128, kernel_size=1, strides=1, activation='relu', padding='same')(X4)
		...
		X2 = Concatenate()([X2, X3])
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = Conv2D(128, kernel_size=1, strides=1, activation='tanh', padding='same')(X2)
		X2 = Conv2D(128, kernel_size=1, strides=1, activation='selu', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = Conv2D(128, kernel_size=1, strides=1, activation='tanh', padding='same')(X2)
		...
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(128, kernel_size=1, strides=1, activation='tanh', padding='same')(X1)
		X = Concatenate()([X, X1])
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		X = Conv2D(460, kernel_size=1, strides=1, activation='tanh', padding='valid')(X)
		X = Dropout(0.20)(X)
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)

		X = GlobalMaxPooling2D()(X)
		X = Dense(216, activation='selu')(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../architecture_img/architecture_5.png")
	...
	log_file = open( "../architecture_log/architecture_5.log", "w")
	...
	print('OK: file ../architecture_log/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../architecture_log/architecture_5_error.log has been create')
	error_file = open("../architecture_log/architecture_5_error.log" , "w")
	...
	with file:
		...
		# writer.writeheader()
		writer.writerow({'file_name' : 'architecture_5',
