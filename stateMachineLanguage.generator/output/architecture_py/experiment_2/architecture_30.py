...
try:
	def getModel():
		...
		X = Conv2D(64, kernel_size=4, strides=4, activation='relu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_30.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_30.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_30.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_30_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_30_error.log" , "w")
	...
	with file:
		...
		# writer.writeheader()
		writer.writerow({'file_name' : 'architecture_30',
