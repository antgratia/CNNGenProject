...
try:
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_4.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_4.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_4.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_4_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_4_error.log" , "w")
