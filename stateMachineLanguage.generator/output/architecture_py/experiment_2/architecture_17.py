...
try:
	def getModel():
		...
		X = Conv2D(32, kernel_size=4, strides=3, activation='selu', padding='same')(X)
		...
		X = Conv2D(57, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)

		X1 = Conv2D(57, kernel_size=5, strides=1, activation='selu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(57, kernel_size=6, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(57, kernel_size=6, strides=1, activation='relu', padding='same')(X1)
		X = Concatenate()([X, X1])
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_17.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_17.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_17.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_17_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_17_error.log" , "w")
	...
	with file:
		...
		# writer.writeheader()
		writer.writerow({'file_name' : 'architecture_17',
