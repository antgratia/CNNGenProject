...
try:
	def getModel():
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(64, kernel_size=4, strides=3, activation='relu', padding='valid')(X)
		...
		X = MaxPooling2D(pool_size=2, strides=2, padding='valid')(X)
		X = Conv2D(256, kernel_size=2, strides=1, activation='tanh', padding='same')(X)
		X = MaxPooling2D(pool_size=1, strides=1, padding='valid')(X)

		X = GlobalAveragePooling2D()(X)
		X = Dropout(0.40)(X)
		X = Dense(204, activation='relu')(X)
		X = Dense(46, activation='tanh')(X)
		X = Dense(10, activation='softmax')(X)
		model = Model(inputs=X_input, outputs=X)
		return model

	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_5.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_5.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_5_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_5_error.log" , "w")
