...
try:
	def getModel():
		...
		X = AveragePooling2D(pool_size=5, strides=2, padding='same')(X)
		X = Conv2D(64, kernel_size=4, strides=2, activation='tanh', padding='same')(X)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(64, kernel_size=3, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(64, kernel_size=2, strides=1, activation='tanh', padding='same')(X)

		X = Concatenate()([X, X1])
		X = MaxPooling2D(pool_size=7, strides=1, padding='same')(X)
		X = Conv2D(115, kernel_size=1, strides=1, activation='relu', padding='same')(X)

		X2 = X1
		X2 = AveragePooling2D(pool_size=4, strides=1, padding='same')(X2)
		X2 = Conv2D(115, kernel_size=2, strides=1, activation='selu', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = Conv2D(115, kernel_size=2, strides=1, activation='selu', padding='same')(X2)
		X2 = Conv2D(115, kernel_size=3, strides=1, activation='relu', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)

		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(115, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(115, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X1 = Conv2D(115, kernel_size=1, strides=1, activation='selu', padding='same')(X1)
		X1 = Concatenate()([X1, X2])
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(115, kernel_size=2, strides=1, activation='selu', padding='same')(X)
		X = Conv2D(115, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.40)(X)
		X = Conv2D(115, kernel_size=2, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.20)(X)

		X2 = X1
		X2 = AveragePooling2D(pool_size=6, strides=1, padding='same')(X2)
		X2 = Conv2D(115, kernel_size=2, strides=1, activation='relu', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = AveragePooling2D(pool_size=4, strides=1, padding='same')(X2)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(115, kernel_size=1, strides=1, activation='relu', padding='same')(X)
		X = Conv2D(115, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(207, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		X = AveragePooling2D(pool_size=3, strides=1, padding='same')(X)

		X = Add()([X, X1])
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(207, kernel_size=1, strides=1, activation='tanh', padding='same')(X)
		X = Dropout(0.40)(X)

		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(207, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(207, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(207, kernel_size=1, strides=1, activation='tanh', padding='same')(X1)
		X = Add()([X, X1])
		X = Conv2D(414, kernel_size=1, strides=1, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.01)(X)
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)
		X = Conv2D(828, kernel_size=3, strides=1, activation='relu', padding='valid')(X)
		X = AveragePooling2D(pool_size=1, strides=1, padding='valid')(X)
		X = Conv2D(1656, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = MaxPooling2D(pool_size=1, strides=1, padding='valid')(X)

		X = GlobalMaxPooling2D()(X)
		X = Dropout(0.10)(X)
		X = Dense(331, activation='selu')(X)
		X = Dense(142, activation='relu')(X)
		X = Dense(34, activation='tanh')(X)
		X = Dropout(0.10)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_8.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_8.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_8.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_8_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_8_error.log" , "w")
