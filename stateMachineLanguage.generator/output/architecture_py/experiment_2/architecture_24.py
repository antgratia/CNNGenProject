...
try:
	def getModel():
		...
		X = Add()([X, X1])
		X = AveragePooling2D(pool_size=4, strides=4, padding='valid')(X)
		...
		X = Flatten()(X)
		X = Dense(409, activation='selu')(X)
		X = Dense(171, activation='tanh')(X)
		X = Dense(44, activation='selu')(X)
		X = Dense(10, activation='softmax')(X)
		model = Model(inputs=X_input, outputs=X)
		return model

	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_24.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_24.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_24.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_24_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_24_error.log" , "w")
	...
	with file:
		...
		# writer.writeheader()
		writer.writerow({'file_name' : 'architecture_24',
