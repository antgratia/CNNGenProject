...
try:
	def getModel():
		...
		X = Conv2D(64, kernel_size=4, strides=3, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_28.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_28.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_28.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_28_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_28_error.log" , "w")
	...
	with file:
		...
		# writer.writeheader()
		writer.writerow({'file_name' : 'architecture_28',
