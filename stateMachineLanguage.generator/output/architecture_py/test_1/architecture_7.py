...
try:
	def getModel():
		...
		X = Conv2D(3, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(6, kernel_size=3, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(36, kernel_size=5, strides=3, activation='relu', padding='same')(X)
		X = MaxPooling2D(pool_size=2, strides=1, padding='same')(X)

		X1 = Conv2D(52, kernel_size=12, strides=2, activation='selu', padding='valid')(X1)
		X = Concatenate()([X, X1])
		X = Dropout(0.20)(X)
		...
		X = Conv2D(68, kernel_size=1, strides=1, activation='relu', padding='same')(X)
		X = Conv2D(100, kernel_size=1, strides=1, activation='relu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)

		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(68, kernel_size=1, strides=1, activation='tanh', padding='same')(X1)
		X1 = Conv2D(116, kernel_size=1, strides=1, activation='tanh', padding='valid')(X1)
		X = Concatenate()([X, X1])
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		X = Conv2D(132, kernel_size=1, strides=1, activation='tanh', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		...
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(132, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(132, kernel_size=1, strides=1, activation='tanh', padding='same')(X)
		...
		X4 = Conv2D(132, kernel_size=1, strides=1, activation='tanh', padding='same')(X4)
		X4 = Conv2D(132, kernel_size=1, strides=1, activation='selu', padding='same')(X4)
		X = Concatenate()([X, X4])
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)

		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X3 = Conv2D(132, kernel_size=1, strides=1, activation='relu', padding='same')(X3)
		X3 = Conv2D(132, kernel_size=1, strides=1, activation='selu', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X = Concatenate()([X, X3])
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_1/architecture_7.png")
	...
	log_file = open( "../../architecture_log/test_1/architecture_7.log", "w")
	...
	print('OK: file ../../architecture_log/test_1/architecture_7.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_1/architecture_7_error.log has been create')
	error_file = open("../../architecture_log/test_1/architecture_7_error.log" , "w")
