...
try:
	def getModel():
		...
		X = Conv2D(20, kernel_size=1, strides=1, activation='tanh', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = MaxPooling2D(pool_size=2, strides=1, padding='same')(X)

		X1 = X
		X = MaxPooling2D(pool_size=6, strides=4, padding='same')(X)

		X2 = X1
		X2 = MaxPooling2D(pool_size=3, strides=2, padding='valid')(X2)
		X2 = Conv2D(20, kernel_size=3, strides=1, activation='tanh', padding='same')(X2)
		X2 = BatchNormalization(epsilon=0.00, axis=3)(X2)
		X2 = Conv2D(20, kernel_size=2, strides=1, activation='tanh', padding='same')(X2)
		X2 = Dropout(0.10)(X2)
		X2 = Conv2D(20, kernel_size=3, strides=1, activation='tanh', padding='same')(X2)

		X3 = X2
		X3 = AveragePooling2D(pool_size=3, strides=1, padding='valid')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X3 = Conv2D(20, kernel_size=1, strides=1, activation='tanh', padding='same')(X3)
		X3 = Conv2D(20, kernel_size=1, strides=1, activation='tanh', padding='same')(X3)
		X3 = Conv2D(20, kernel_size=1, strides=1, activation='relu', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X3 = MaxPooling2D(pool_size=1, strides=1, padding='same')(X3)

		X2 = Concatenate()([X2, X3])
		X2 = AveragePooling2D(pool_size=1, strides=1, padding='valid')(X2)

		X1 = Conv2D(20, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(20, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		...
		X1 = Conv2D(20, kernel_size=1, strides=1, activation='relu', padding='valid')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(20, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X = Concatenate()([X, X1])
		X = Dropout(0.50)(X)
