...
try:
	def getModel():
		...
		X = Conv2D(16, kernel_size=5, strides=4, activation='tanh', padding='same')(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_2/architecture_8.png")
	...
	log_file = open( "../../architecture_log/test_2/architecture_8.log", "w")
	...
	print('OK: file ../../architecture_log/test_2/architecture_8.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_2/architecture_8_error.log has been create')
	error_file = open("../../architecture_log/test_2/architecture_8_error.log" , "w")
