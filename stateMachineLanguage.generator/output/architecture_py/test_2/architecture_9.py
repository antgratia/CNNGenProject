...
try:
	def getModel():
		...
		X1 = X
		X = Conv2D(3, kernel_size=6, strides=1, activation='selu', padding='same')(X)
		...
		X = Conv2D(3, kernel_size=6, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.50)(X)
		X = MaxPooling2D(pool_size=3, strides=1, padding='same')(X)

		X2 = Conv2D(3, kernel_size=3, strides=1, activation='selu', padding='same')(X2)
		X = Add()([X, X2])
		X = Conv2D(3, kernel_size=2, strides=1, activation='tanh', padding='same')(X)
		X = Conv2D(16, kernel_size=2, strides=2, activation='relu', padding='same')(X)
		X = AveragePooling2D(pool_size=2, strides=1, padding='same')(X)

		X1 = Conv2D(16, kernel_size=2, strides=2, activation='tanh', padding='valid')(X1)
		X = Add()([X, X1])
		X = Dropout(0.80)(X)
		...
		X3 = Conv2D(48, kernel_size=1, strides=1, activation='selu', padding='same')(X3)
		X3 = Conv2D(48, kernel_size=1, strides=1, activation='selu', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X = Add()([X, X3])
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		...
		X5 = Conv2D(48, kernel_size=1, strides=1, activation='selu', padding='same')(X5)
		...
		X5 = BatchNormalization(epsilon=0.00, axis=3)(X5)
		X5 = Conv2D(48, kernel_size=1, strides=1, activation='tanh', padding='same')(X5)
		X5 = Conv2D(48, kernel_size=1, strides=1, activation='selu', padding='same')(X5)
		X = Add()([X, X5])
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		...
		X2 = Conv2D(48, kernel_size=1, strides=1, activation='relu', padding='same')(X2)
		X = Add()([X, X2])
		X = Conv2D(48, kernel_size=1, strides=1, activation='tanh', padding='same')(X)

		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(48, kernel_size=1, strides=1, activation='tanh', padding='same')(X1)
		X1 = Conv2D(48, kernel_size=1, strides=1, activation='tanh', padding='valid')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X = Add()([X, X1])
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_2/architecture_9.png")
	...
	log_file = open( "../../architecture_log/test_2/architecture_9.log", "w")
	...
	print('OK: file ../../architecture_log/test_2/architecture_9.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_2/architecture_9_error.log has been create')
	error_file = open("../../architecture_log/test_2/architecture_9_error.log" , "w")
