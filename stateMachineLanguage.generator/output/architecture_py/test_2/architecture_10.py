...
try:
	def getModel():
		...
		X1 = Conv2D(16, kernel_size=4, strides=2, activation='relu', padding='same')(X1)
		X1 = Conv2D(3, kernel_size=1, strides=1, activation='relu', padding='same')(X1)
		X = Add()([X, X1])
		...
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(48, kernel_size=4, strides=1, activation='relu', padding='valid')(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_2/architecture_10.png")
	...
	log_file = open( "../../architecture_log/test_2/architecture_10.log", "w")
	...
	print('OK: file ../../architecture_log/test_2/architecture_10.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_2/architecture_10_error.log has been create')
	error_file = open("../../architecture_log/test_2/architecture_10_error.log" , "w")
