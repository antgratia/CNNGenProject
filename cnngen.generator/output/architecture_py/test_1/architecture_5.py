...
try:
	def getModel():
		...
		X = Conv2D(20, kernel_size=7, strides=4, activation='selu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(36, kernel_size=3, strides=2, activation='tanh', padding='same')(X)
		X = AveragePooling2D(pool_size=2, strides=1, padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(52, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = Dropout(0.10)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_1/architecture_5.png")
	...
	log_file = open( "../../architecture_log/test_1/architecture_5.log", "w")
	...
	print('OK: file ../../architecture_log/test_1/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_1/architecture_5_error.log has been create')
	error_file = open("../../architecture_log/test_1/architecture_5_error.log" , "w")
