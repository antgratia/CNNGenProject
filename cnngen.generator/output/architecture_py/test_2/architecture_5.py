...
try:
	def getModel():
		...
		X1 = Conv2D(3, kernel_size=3, strides=2, activation='relu', padding='same')(X1)
		X = Add()([X, X1])
		...
		X = Conv2D(16, kernel_size=5, strides=1, activation='selu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_2/architecture_5.png")
	...
	log_file = open( "../../architecture_log/test_2/architecture_5.log", "w")
	...
	print('OK: file ../../architecture_log/test_2/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_2/architecture_5_error.log has been create')
	error_file = open("../../architecture_log/test_2/architecture_5_error.log" , "w")
