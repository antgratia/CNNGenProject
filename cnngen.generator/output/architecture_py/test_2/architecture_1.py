...
try:
	def getModel():
		...
		X2 = Conv2D(3, kernel_size=7, strides=1, activation='tanh', padding='same')(X2)
		X = Add()([X, X2])
		X = AveragePooling2D(pool_size=3, strides=1, padding='same')(X)

		X = Add()([X, X1])
		X = AveragePooling2D(pool_size=2, strides=2, padding='same')(X)
		X = Conv2D(16, kernel_size=4, strides=4, activation='relu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		...
		X = Add()([X, X1])
		X = Conv2D(48, kernel_size=2, strides=2, activation='selu', padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_2/architecture_1.png")
	...
	log_file = open( "../../architecture_log/test_2/architecture_1.log", "w")
	...
	print('OK: file ../../architecture_log/test_2/architecture_1.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_2/architecture_1_error.log has been create')
	error_file = open("../../architecture_log/test_2/architecture_1_error.log" , "w")
