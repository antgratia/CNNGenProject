...
tracker = OfflineEmissionsTracker(country_iso_code="BEL", log_level='error', output_file="architecture_2_emissions.csv", output_dir="../../architecture_emissions/test/" )
...
try:
	def getModel():
		...
		X = Conv2D(32, kernel_size=3, strides=3, activation='tanh', padding='same')(X)
		X = MaxPooling2D(pool_size=6, strides=1, padding='valid')(X)
		X = Conv2D(48, kernel_size=5, strides=1, activation='tanh', padding='valid')(X)
	...
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test/architecture_2.png")
	...
	log_file = open( "../../architecture_log/test/architecture_2.log", "w")
	...
	print('OK: file ../../architecture_log/test/architecture_2.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test/architecture_2_error.log has been create')
	error_file = open("../../architecture_log/test/architecture_2_error.log" , "w")
