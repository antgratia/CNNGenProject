...
try:
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_1.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_1.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_1.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_1_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_1_error.log" , "w")
