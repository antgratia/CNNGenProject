...
try:
	def getModel():
		...
		X = Conv2D(3, kernel_size=4, strides=2, activation='selu', padding='valid')(X)

		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(3, kernel_size=2, strides=1, activation='relu', padding='same')(X1)
		X1 = BatchNormalization(epsilon=0.00, axis=3)(X1)
		X1 = Conv2D(16, kernel_size=3, strides=2, activation='relu', padding='valid')(X1)
		X = Concatenate()([X, X1])
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)
		X = Conv2D(18, kernel_size=3, strides=1, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.50)(X)

		X2 = X
		X = Conv2D(18, kernel_size=1, strides=1, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.10)(X)
		...
		X4 = Conv2D(18, kernel_size=3, strides=1, activation='relu', padding='same')(X4)
		X = Concatenate()([X, X4])
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)

		X3 = Conv2D(18, kernel_size=3, strides=1, activation='selu', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X = Concatenate()([X, X3])
		X = Conv2D(26, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Dropout(0.50)(X)
		...
		X4 = X
		X = Conv2D(26, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = Conv2D(26, kernel_size=2, strides=1, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = MaxPooling2D(pool_size=3, strides=1, padding='same')(X)

		X4 = Conv2D(26, kernel_size=3, strides=1, activation='tanh', padding='same')(X4)
		X4 = BatchNormalization(epsilon=0.00, axis=3)(X4)
		X4 = BatchNormalization(epsilon=0.00, axis=3)(X4)
		X4 = Conv2D(26, kernel_size=1, strides=1, activation='relu', padding='same')(X4)
		X = Concatenate()([X, X4])
		...
		X5 = Conv2D(42, kernel_size=3, strides=1, activation='tanh', padding='same')(X5)
		X = Concatenate()([X, X5])
		X = Conv2D(50, kernel_size=3, strides=1, activation='selu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)

		X5 = X
		X = Conv2D(50, kernel_size=2, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = MaxPooling2D(pool_size=3, strides=1, padding='same')(X)

		X = Concatenate()([X, X5])

		X4 = Conv2D(42, kernel_size=2, strides=1, activation='selu', padding='same')(X4)
		X4 = BatchNormalization(epsilon=0.00, axis=3)(X4)
		X4 = Conv2D(42, kernel_size=2, strides=1, activation='relu', padding='same')(X4)
		X = Concatenate()([X, X4])

		X3 = Conv2D(26, kernel_size=3, strides=1, activation='selu', padding='same')(X3)
		X3 = BatchNormalization(epsilon=0.00, axis=3)(X3)
		X = Concatenate()([X, X3])
		X = Conv2D(42, kernel_size=1, strides=1, activation='selu', padding='same')(X)
		X = Conv2D(42, kernel_size=1, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = MaxPooling2D(pool_size=3, strides=1, padding='same')(X)
		...
		X2 = Conv2D(48, kernel_size=2, strides=1, activation='tanh', padding='same')(X2)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(80, kernel_size=1, strides=1, activation='selu', padding='valid')(X)
		X = AveragePooling2D(pool_size=1, strides=1, padding='valid')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(96, kernel_size=1, strides=1, activation='relu', padding='same')(X)
		X = Dropout(0.01)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_2/architecture_9.png")
	...
	log_file = open( "../../architecture_log/experiment_2/architecture_9.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_2/architecture_9.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_2/architecture_9_error.log has been create')
	error_file = open("../../architecture_log/experiment_2/architecture_9_error.log" , "w")
