...
tracker = OfflineEmissionsTracker(country_iso_code="BEL", log_level='error', output_file="architecture_9_emissions.csv", output_dir="../../architecture_emissions/test_refactoring/" )
...
try:
	def getModel():
		...
		X1 = Conv2D(16, kernel_size=3, strides=1, activation='selu', padding='valid')(X1)
		X1 = BatchNormalization(epsilon=1.1E-10, axis=3)(X1)
		X = Add()([X, X1])
		X = Dropout(0.10)(X)
		X = AveragePooling2D(pool_size=1, strides=1, padding='same')(X)
		X = BatchNormalization(epsilon=1.001E-5, axis=3)(X)
		X = Conv2D(32, kernel_size=2, strides=1, activation='selu', padding='valid')(X)
		X = AveragePooling2D(pool_size=2, strides=1, padding='same')(X)
	...
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_refactoring/architecture_9.png")
	...
	log_file = open( "../../architecture_log/test_refactoring/architecture_9.log", "w")
	...
	print('OK: file ../../architecture_log/test_refactoring/architecture_9.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_refactoring/architecture_9_error.log has been create')
	error_file = open("../../architecture_log/test_refactoring/architecture_9_error.log" , "w")
