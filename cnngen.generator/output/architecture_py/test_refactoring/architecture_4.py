...
tracker = OfflineEmissionsTracker(country_iso_code="BEL", log_level='error', output_file="architecture_4_emissions.csv", output_dir="../../architecture_emissions/test_refactoring/" )
...
try:
	def getModel():
		...
		X = Conv2D(1, kernel_size=4, strides=1, activation='tanh', padding='same')(X)
		X = Dropout(0.01)(X)
		...
		X = Conv2D(16, kernel_size=5, strides=2, activation='tanh', padding='valid')(X)
		...
		X = Conv2D(48, kernel_size=3, strides=1, activation='tanh', padding='same')(X)
		X = BatchNormalization(epsilon=1.1E-7, axis=3)(X)
		X = MaxPooling2D(pool_size=1, strides=1, padding='same')(X)

		X1 = BatchNormalization(epsilon=1.1E-5, axis=3)(X1)
		X1 = Conv2D(32, kernel_size=1, strides=1, activation='tanh', padding='same')(X1)
		X1 = Conv2D(48, kernel_size=2, strides=1, activation='tanh', padding='same')(X1)
		X = Add()([X, X1])
	...
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_refactoring/architecture_4.png")
	...
	log_file = open( "../../architecture_log/test_refactoring/architecture_4.log", "w")
	...
	print('OK: file ../../architecture_log/test_refactoring/architecture_4.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_refactoring/architecture_4_error.log has been create')
	error_file = open("../../architecture_log/test_refactoring/architecture_4_error.log" , "w")
