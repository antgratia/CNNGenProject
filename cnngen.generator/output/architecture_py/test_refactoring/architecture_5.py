...
tracker = OfflineEmissionsTracker(country_iso_code="BEL", log_level='error', output_file="architecture_5_emissions.csv", output_dir="../../architecture_emissions/test_refactoring/" )
...
try:
	def getModel():
		...
		X1 = Conv2D(16, kernel_size=6, strides=2, activation='relu', padding='valid')(X1)
		X1 = BatchNormalization(epsilon=1.1E-7, axis=3)(X1)
		X = Add()([X, X1])
		X = MaxPooling2D(pool_size=5, strides=1, padding='same')(X)
		X = Conv2D(16, kernel_size=4, strides=1, activation='relu', padding='same')(X)
	...
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_refactoring/architecture_5.png")
	...
	log_file = open( "../../architecture_log/test_refactoring/architecture_5.log", "w")
	...
	print('OK: file ../../architecture_log/test_refactoring/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_refactoring/architecture_5_error.log has been create')
	error_file = open("../../architecture_log/test_refactoring/architecture_5_error.log" , "w")
