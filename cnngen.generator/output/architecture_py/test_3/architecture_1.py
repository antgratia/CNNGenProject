...
try:
	def getModel():
		...
		X = Conv2D(80, kernel_size=3, strides=1, activation='selu', padding='valid')(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/test_3/architecture_1.png")
	model.compile(optimizer='adam', loss=keras.losses.sparse_categorical_crossentropy, metrics=['accuracy'])

	es = EarlyStopping(monitor='loss', min_delta=0.001, verbose=1, restore_best_weights=True, patience=7)
	tb = TensorBoard(log_dir="../../architecture_tb/test_3/architecture_1")
	list_cb = [es, tb]
	start = time()
	...
	log_file = open( "../../architecture_log/test_3/architecture_1.log", "w")
	...
	print('OK: file ../../architecture_log/test_3/architecture_1.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/test_3/architecture_1_error.log has been create')
	error_file = open("../../architecture_log/test_3/architecture_1_error.log" , "w")
	...
	file = open("../../architecture_csv/test_3/architecture_results.csv", 'a', newline ='')
	with file:
		# identifying header 
