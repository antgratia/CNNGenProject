...
try:
	def getModel():
		...
		X = Conv2D(32, kernel_size=7, strides=4, activation='relu', padding='valid')(X)
		...
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
		X = Conv2D(128, kernel_size=2, strides=2, activation='relu', padding='same')(X)
		X = BatchNormalization(epsilon=0.00, axis=3)(X)
	...
	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_1/architecture_9.png")
	...
	log_file = open( "../../architecture_log/experiment_1/architecture_9.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_1/architecture_9.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_1/architecture_9_error.log has been create')
	error_file = open("../../architecture_log/experiment_1/architecture_9_error.log" , "w")
