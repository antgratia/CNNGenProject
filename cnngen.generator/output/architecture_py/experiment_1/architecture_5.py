...
try:
	def getModel():
		...
		X = Flatten()(X)
		X = Dropout(0.01)(X)
		X = Dense(460, activation='selu')(X)
		X = Dense(10, activation='softmax')(X)
		model = Model(inputs=X_input, outputs=X)
		return model

	model = getModel()
	plot_model(model, show_shapes=True, to_file="../../architecture_img/experiment_1/architecture_5.png")
	...
	log_file = open( "../../architecture_log/experiment_1/architecture_5.log", "w")
	...
	print('OK: file ../../architecture_log/experiment_1/architecture_5.log has been create')
...
# something go wrong
	...
	print('error: file ../../architecture_log/experiment_1/architecture_5_error.log has been create')
	error_file = open("../../architecture_log/experiment_1/architecture_5_error.log" , "w")
