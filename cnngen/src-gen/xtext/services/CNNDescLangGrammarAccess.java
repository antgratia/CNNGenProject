...
@Singleton
public class CNNDescLangGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class CNNDescLangElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.CNNDescLang");
		private final Assignment cCnndesclangAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cCnndesclangArchitectureParserRuleCall_0 = (RuleCall)cCnndesclangAssignment.eContents().get(0);
		
		//CNNDescLang : cnndesclang = (Architecture);
		@Override public ParserRule getRule() { return rule; }
		
		//cnndesclang = (Architecture)
		public Assignment getCnndesclangAssignment() { return cCnndesclangAssignment; }
		
		//(Architecture)
		public RuleCall getCnndesclangArchitectureParserRuleCall_0() { return cCnndesclangArchitectureParserRuleCall_0; }
	}
	public class ArchitectureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Architecture");
	...
	public class DropoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Dropout");
	...
	public class PoolingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Pooling");
	...
	public class ConvolutionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Convolution");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class GlobalPoolingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.GlobalPooling");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FlattenOrGlobalElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.FlattenOrGlobal");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class IntersticeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Interstice");
	...
	public class ClassificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Classification");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConvDropElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.ConvDrop");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MergeConvElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.MergeConv");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConvOrMergeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.ConvOrMerge");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class LeftElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Left");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RightElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Right");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MergeBodyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.MergeBody");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MergeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.Merge");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FeatureExtractionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "xtext.CNNDescLang.FeatureExtraction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final CNNDescLangElements pCNNDescLang;
	...
	@Inject
	public CNNDescLangGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pCNNDescLang = new CNNDescLangElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("xtext.CNNDescLang".equals(grammar.getName())) {
				return grammar;
			}
	...
	//CNNDescLang : cnndesclang = (Architecture);
	public CNNDescLangElements getCNNDescLangAccess() {
		return pCNNDescLang;
	}
	
	public ParserRule getCNNDescLangRule() {
		return getCNNDescLangAccess().getRule();
	}
