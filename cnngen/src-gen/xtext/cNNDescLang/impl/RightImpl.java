 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.RightImpl#getConv <em>Conv</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.RightImpl#getEmpty <em>Empty</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RightImpl extends MinimalEObjectImpl.Container implements Right
{
  ...
  {
    return CNNDescLangPackage.Literals.RIGHT;
  }
  ...
  public EList<Convolution> getConv()
  {
    if (conv == null)
    {
      conv = new EObjectContainmentEList<Convolution>(Convolution.class, this, CNNDescLangPackage.RIGHT__CONV);
    }
    return conv;
  }
  ...
  public void setEmpty(String newEmpty)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.RIGHT__EMPTY, oldEmpty, empty));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.RIGHT__CONV:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.RIGHT__CONV:
        return getConv();
      case CNNDescLangPackage.RIGHT__EMPTY:
        return getEmpty();
    }
