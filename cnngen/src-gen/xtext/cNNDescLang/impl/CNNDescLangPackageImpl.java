...
import xtext.cNNDescLang.CNNDescLangFactory;
 ...
 * @generated
 */
public class CNNDescLangPackageImpl extends EPackageImpl implements CNNDescLangPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private EClass cnnDescLangEClass = null;
   ...
   * @see xtext.cNNDescLang.CNNDescLangPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private CNNDescLangPackageImpl()
  {
    super(eNS_URI, CNNDescLangFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link CNNDescLangPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static CNNDescLangPackage init()
  {
    if (isInited) return (CNNDescLangPackage)EPackage.Registry.INSTANCE.getEPackage(CNNDescLangPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredCNNDescLangPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    CNNDescLangPackageImpl theCNNDescLangPackage = registeredCNNDescLangPackage instanceof CNNDescLangPackageImpl ? (CNNDescLangPackageImpl)registeredCNNDescLangPackage : new CNNDescLangPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theCNNDescLangPackage.createPackageContents();

    // Initialize created meta-data
    theCNNDescLangPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theCNNDescLangPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(CNNDescLangPackage.eNS_URI, theCNNDescLangPackage);
    return theCNNDescLangPackage;
  }
   ...
   */
  @Override
  public EClass getCNNDescLang()
  {
    return cnnDescLangEClass;
  }
   ...
   */
  @Override
  public EReference getCNNDescLang_Cnndesclang()
  {
    return (EReference)cnnDescLangEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public CNNDescLangFactory getCNNDescLangFactory()
  {
    return (CNNDescLangFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    cnnDescLangEClass = createEClass(CNN_DESC_LANG);
    createEReference(cnnDescLangEClass, CNN_DESC_LANG__CNNDESCLANG);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(cnnDescLangEClass, CNNDescLang.class, "CNNDescLang", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCNNDescLang_Cnndesclang(), this.getArchitecture(), null, "cnndesclang", null, 0, 1, CNNDescLang.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
