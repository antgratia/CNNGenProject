 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.ConvolutionImpl#getBnconv <em>Bnconv</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.ConvolutionImpl#getConvbn <em>Convbn</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.ConvolutionImpl#getConv <em>Conv</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.ConvolutionImpl#getUpconv <em>Upconv</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConvolutionImpl extends MinimalEObjectImpl.Container implements Convolution
{
  ...
  {
    return CNNDescLangPackage.Literals.CONVOLUTION;
  }
  ...
  public void setBnconv(String newBnconv)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONVOLUTION__BNCONV, oldBnconv, bnconv));
  }
  ...
  public void setConvbn(String newConvbn)
  {
    ...
    convbn = newConvbn;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONVOLUTION__CONVBN, oldConvbn, convbn));
  }
  ...
  public void setConv(String newConv)
  {
    ...
    conv = newConv;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONVOLUTION__CONV, oldConv, conv));
  }
  ...
  public void setUpconv(String newUpconv)
  {
    ...
    upconv = newUpconv;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONVOLUTION__UPCONV, oldUpconv, upconv));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.CONVOLUTION__BNCONV:
        return getBnconv();
      case CNNDescLangPackage.CONVOLUTION__CONVBN:
        return getConvbn();
      case CNNDescLangPackage.CONVOLUTION__CONV:
        return getConv();
      case CNNDescLangPackage.CONVOLUTION__UPCONV:
        return getUpconv();
    }
