 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.FlattenOrGlobalImpl#getFlat <em>Flat</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.FlattenOrGlobalImpl#getGp <em>Gp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlattenOrGlobalImpl extends MinimalEObjectImpl.Container implements FlattenOrGlobal
{
  ...
  {
    return CNNDescLangPackage.Literals.FLATTEN_OR_GLOBAL;
  }
  ...
  public void setFlat(String newFlat)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.FLATTEN_OR_GLOBAL__FLAT, oldFlat, flat));
  }
  ...
  public void setGp(String newGp)
  {
    ...
    gp = newGp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.FLATTEN_OR_GLOBAL__GP, oldGp, gp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.FLATTEN_OR_GLOBAL__FLAT:
        return getFlat();
      case CNNDescLangPackage.FLATTEN_OR_GLOBAL__GP:
        return getGp();
    }
