 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.IntersticeImpl#getFg <em>Fg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntersticeImpl extends MinimalEObjectImpl.Container implements Interstice
{
  ...
  {
    return CNNDescLangPackage.Literals.INTERSTICE;
  }
  ...
  public NotificationChain basicSetFg(FlattenOrGlobal newFg, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.INTERSTICE__FG, oldFg, newFg);
  ...
  public void setFg(FlattenOrGlobal newFg)
  {
    if (newFg != fg)
    {
      ...
      if (fg != null)
        msgs = ((InternalEObject)fg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.INTERSTICE__FG, null, msgs);
      if (newFg != null)
        msgs = ((InternalEObject)newFg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.INTERSTICE__FG, null, msgs);
      msgs = basicSetFg(newFg, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.INTERSTICE__FG, newFg, newFg));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.INTERSTICE__FG:
