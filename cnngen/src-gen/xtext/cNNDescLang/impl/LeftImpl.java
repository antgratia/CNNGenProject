 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.LeftImpl#getP <em>P</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.LeftImpl#getCom <em>Com</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.LeftImpl#getPool <em>Pool</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeftImpl extends MinimalEObjectImpl.Container implements Left
{
  ...
  {
    return CNNDescLangPackage.Literals.LEFT;
  }
  ...
  public void setP(String newP)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.LEFT__P, oldP, p));
  }
  ...
  public NotificationChain basicSetCom(ConvOrMerge newCom, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.LEFT__COM, oldCom, newCom);
  ...
  public void setCom(ConvOrMerge newCom)
  {
    if (newCom != com)
    {
      ...
      if (com != null)
        msgs = ((InternalEObject)com).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.LEFT__COM, null, msgs);
      if (newCom != null)
        msgs = ((InternalEObject)newCom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.LEFT__COM, null, msgs);
      msgs = basicSetCom(newCom, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.LEFT__COM, newCom, newCom));
  }
  ...
  public void setPool(String newPool)
  {
    ...
    pool = newPool;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.LEFT__POOL, oldPool, pool));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.LEFT__COM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.LEFT__P:
        return getP();
      case CNNDescLangPackage.LEFT__COM:
        return getCom();
      case CNNDescLangPackage.LEFT__POOL:
        return getPool();
    }
