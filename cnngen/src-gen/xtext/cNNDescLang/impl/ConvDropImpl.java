 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.cNNDescLang.impl.ConvDropImpl#getConv <em>Conv</em>}</li>
 *   <li>{@link xtext.cNNDescLang.impl.ConvDropImpl#getDrop <em>Drop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConvDropImpl extends MinimalEObjectImpl.Container implements ConvDrop
{
  ...
  {
    return CNNDescLangPackage.Literals.CONV_DROP;
  }
  ...
  public NotificationChain basicSetConv(Convolution newConv, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONV_DROP__CONV, oldConv, newConv);
  ...
  public void setConv(Convolution newConv)
  {
    if (newConv != conv)
    {
      ...
      if (conv != null)
        msgs = ((InternalEObject)conv).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.CONV_DROP__CONV, null, msgs);
      if (newConv != null)
        msgs = ((InternalEObject)newConv).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CNNDescLangPackage.CONV_DROP__CONV, null, msgs);
      msgs = basicSetConv(newConv, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONV_DROP__CONV, newConv, newConv));
  }
  ...
  public void setDrop(String newDrop)
  {
    ...
    drop = newDrop;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNNDescLangPackage.CONV_DROP__DROP, oldDrop, drop));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.CONV_DROP__CONV:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNNDescLangPackage.CONV_DROP__CONV:
        return getConv();
      case CNNDescLangPackage.CONV_DROP__DROP:
        return getDrop();
    }
