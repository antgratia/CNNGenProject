...
import xtext.ide.contentassist.antlr.internal.InternalCNNDescLangParser;
import xtext.services.CNNDescLangGrammarAccess;

public class CNNDescLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CNNDescLangGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CNNDescLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCNNDescLangAccess().getCnndesclangAssignment(), "rule__CNNDescLang__CnndesclangAssignment");
	...
	@Override
	protected InternalCNNDescLangParser createParser() {
		InternalCNNDescLangParser result = new InternalCNNDescLangParser(null);
